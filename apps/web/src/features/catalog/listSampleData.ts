...
/**
 * `count` trades factices, groupés ~40/jour (démo `@tanstack/react-virtual`
 * avec 1 000 lignes). Déterministe (graine fixe).
 */
...
/** Regroupe des trades déjà triés par `day` en sections (une par jour). */
