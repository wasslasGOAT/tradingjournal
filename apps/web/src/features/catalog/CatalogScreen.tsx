...
import type { DateRangePickerLabels, DateRangeShortcut, TradingDayRange } from "@/components/ui/date-range-picker"
      ...
      <CatalogSection testId="catalog-section-cards" title={t("catalog.sections.cards")}>
        <div className="flex flex-col gap-2">
          <Card data-testid="catalog-card" className="gap-1 p-4">
            <p className="text-base font-semibold text-foreground">{t("catalog.cards.cardTitle")}</p>
