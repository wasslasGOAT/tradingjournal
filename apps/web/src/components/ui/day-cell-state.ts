...
/**
 * Logique pure d'état de `DayCell` (W-4, copie de
 * `packages/ui/src/components/DayCell/dayCellState.ts`, gelé — ARCHITECTURE
 * §6.2 : « cellule de calendrier : états profit / perte / journal seul /
 * aujourd'hui / vide »).
 *
