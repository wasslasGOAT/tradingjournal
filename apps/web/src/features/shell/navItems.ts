...
export const NAV_ITEMS: readonly NavItem[] = [
  { id: "dashboard", to: "/", labelKey: "nav.dashboard", icon: LayoutDashboard, tab: true, sidebar: true },
  {
    id: "calendar",
    to: "/calendar",
  ...
  { id: "trades", to: "/trades", labelKey: "nav.trades", icon: ListOrdered, tab: true, sidebar: true },
  { id: "journal", to: "/journal", labelKey: "nav.journal", icon: NotebookPen, tab: true, sidebar: true },
  { id: "more", to: "/more", labelKey: "nav.more", icon: MoreHorizontal, tab: true, sidebar: false },
  {
    id: "analytics",
    to: "/analytics",
  ...
  { id: "rules", to: "/rules", labelKey: "nav.rules", icon: ShieldCheck, tab: false, sidebar: true },
  {
    id: "settings",
    to: "/settings",
