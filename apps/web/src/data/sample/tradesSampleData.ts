...
const MAIN_SEEDS: readonly SampleTradeSeed[] = [
  { id: "m-0803", tradingDate: "2026-08-03", symbol: "EURUSD", direction: "long", netPnl: "145.00" },
  { id: "m-0804", tradingDate: "2026-08-04", symbol: "GBPUSD", direction: "short", netPnl: "-60.00" },
  { id: "m-0805", tradingDate: "2026-08-05", symbol: "XAUUSD", direction: "long", netPnl: "220.50" },
  { id: "m-0806", tradingDate: "2026-08-06", symbol: "NAS100", direction: "short", netPnl: "-110.25" },
  { id: "m-0807", tradingDate: "2026-08-07", symbol: "EURUSD", direction: "long", netPnl: "80.00" },
  { id: "m-0810", tradingDate: "2026-08-10", symbol: "GBPUSD", direction: "long", netPnl: "305.10" },
  { id: "m-0811", tradingDate: "2026-08-11", symbol: "XAUUSD", direction: "short", netPnl: "-75.60" },
  { id: "m-0812", tradingDate: "2026-08-12", symbol: "NAS100", direction: "long", netPnl: "130.40" },
  { id: "m-0813", tradingDate: "2026-08-13", symbol: "EURUSD", direction: "short", netPnl: "-200.00" },
  { id: "m-0814", tradingDate: "2026-08-14", symbol: "GBPUSD", direction: "long", netPnl: "90.75" },
  { id: "m-0817", tradingDate: "2026-08-17", symbol: "XAUUSD", direction: "long", netPnl: "260.00" },
  { id: "m-0818", tradingDate: "2026-08-18", symbol: "NAS100", direction: "short", netPnl: "-45.30" },
  { id: "m-0819", tradingDate: "2026-08-19", symbol: "EURUSD", direction: "long", netPnl: "175.20" },
  { id: "m-0820", tradingDate: "2026-08-20", symbol: "GBPUSD", direction: "short", netPnl: "-95.00" },
  { id: "m-0821", tradingDate: "2026-08-21", symbol: "XAUUSD", direction: "long", netPnl: "310.00" },
  { id: "m-0824", tradingDate: "2026-08-24", symbol: "NAS100", direction: "short", netPnl: "-140.00" },
  { id: "m-0825", tradingDate: "2026-08-25", symbol: "EURUSD", direction: "long", netPnl: "220.00" },
  { id: "m-0826", tradingDate: "2026-08-26", symbol: "GBPUSD", direction: "long", netPnl: "60.50" },
  { id: "m-0827", tradingDate: "2026-08-27", symbol: "XAUUSD", direction: "short", netPnl: "-30.00" },
  { id: "m-0828", tradingDate: "2026-08-28", symbol: "NAS100", direction: "long", netPnl: "150.00" },
  // Septembre : mêmes P&L par jour que `apps/app/features/calendar/sampleData.ts` (voir commentaire d'en-tête).
  { id: "m-0901", tradingDate: "2026-09-01", symbol: "EURUSD", direction: "long", netPnl: "312.40" },
  { id: "m-0902", tradingDate: "2026-09-02", symbol: "GBPUSD", direction: "short", netPnl: "-145.10" },
  { id: "m-0904", tradingDate: "2026-09-04", symbol: "XAUUSD", direction: "long", netPnl: "208.90" },
  { id: "m-0907", tradingDate: "2026-09-07", symbol: "NAS100", direction: "long", netPnl: "412.00" },
  { id: "m-0908", tradingDate: "2026-09-08", symbol: "EURUSD", direction: "short", netPnl: "-88.25" },
  { id: "m-0909", tradingDate: "2026-09-09", symbol: "GBPUSD", direction: "long", netPnl: "0" },
  { id: "m-0910", tradingDate: "2026-09-10", symbol: "XAUUSD", direction: "short", netPnl: "156.60" },
  { id: "m-0911", tradingDate: "2026-09-11", symbol: "NAS100", direction: "short", netPnl: "-322.75" },
  { id: "m-0914", tradingDate: "2026-09-14", symbol: "EURUSD", direction: "long", netPnl: "94.10" },
  { id: "m-0915", tradingDate: "2026-09-15", symbol: "GBPUSD", direction: "long", netPnl: "267.30" },
  { id: "m-0917", tradingDate: "2026-09-17", symbol: "XAUUSD", direction: "short", netPnl: "-59.40" },
  { id: "m-0918", tradingDate: "2026-09-18", symbol: "NAS100", direction: "long", netPnl: "331.20" },
...
const PROP_SEEDS: readonly SampleTradeSeed[] = [
  ...
  { id: "p-0806", tradingDate: "2026-08-06", symbol: "US30", direction: "short", netPnl: "-150.00" },
  { id: "p-0810", tradingDate: "2026-08-10", symbol: "GER40", direction: "long", netPnl: "500.00" },
  { id: "p-0812", tradingDate: "2026-08-12", symbol: "GER40", direction: "short", netPnl: "-90.00" },
  { id: "p-0814", tradingDate: "2026-08-14", symbol: "US30", direction: "long", netPnl: "220.00" },
  { id: "p-0818", tradingDate: "2026-08-18", symbol: "GER40", direction: "short", netPnl: "-400.00" },
  { id: "p-0820", tradingDate: "2026-08-20", symbol: "US30", direction: "long", netPnl: "610.00" },
  { id: "p-0824", tradingDate: "2026-08-24", symbol: "GER40", direction: "short", netPnl: "-75.00" },
  { id: "p-0826", tradingDate: "2026-08-26", symbol: "US30", direction: "long", netPnl: "340.00" },
  { id: "p-0828", tradingDate: "2026-08-28", symbol: "GER40", direction: "short", netPnl: "-60.00" },
  ...
  { id: "p-0904", tradingDate: "2026-09-04", symbol: "US30", direction: "short", netPnl: "-180.00" },
  ...
  { id: "p-0909", tradingDate: "2026-09-09", symbol: "GER40", direction: "short", netPnl: "-220.00" },
  { id: "p-0911", tradingDate: "2026-09-11", symbol: "US30", direction: "long", netPnl: "150.00" },
  { id: "p-0914", tradingDate: "2026-09-14", symbol: "GER40", direction: "short", netPnl: "-60.00" },
  ...
  { id: "p-0918", tradingDate: "2026-09-18", symbol: "US30", direction: "short", netPnl: "-310.00" },
 ...
 */
export function toSampleTradeRecord(accountId: SampleAccountId, seed: SampleTradeSeed): TradeRecord {
