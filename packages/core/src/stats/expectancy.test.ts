...
describe('computeExpectancy', () => {
  ...
  it('inclut les trades breakeven dans la moyenne (contrairement au win rate)', () => {
    const trades = [buildTrade({ netPnl: d('30') }), buildTrade({ netPnl: d('0') }), buildTrade({ netPnl: d('-15') })];
    // (30 + 0 - 15) / 3 = 5
...
describe('computeAverageWinLoss', () => {
  ...
  it('aucun gagnant : averageWin null, averageLoss défini', () => {
    const result = computeAverageWinLoss([buildTrade({ netPnl: d('-10') }), buildTrade({ netPnl: d('-30') })]);
  ...
  it('cas golden : gain moyen 6187.50, perte moyenne -2118.73...', () => {
    ...
    const losses = Array.from({ length: 21 }, () => buildTrade({ netPnl: d('-2118.734761904761905') }));
...
describe('computeAverageRatio', () => {
  it('cas golden : ratio moyen 2.92 arrondi (PF 0.56 * 21/4)', () => {
    ...
    const losses = [
      '2000.00', '1500.00', '1500.00', '1800.00', '1700.00', '1500.00', '2200.00', '1600.00', '1200.00',
      '2500.00', '1500.00', '1000.00', '1900.00', '1600.00', '1500.00', '3000.00', '2000.00', '6000.00',
      '4000.00', '2277.71', '2215.72',
